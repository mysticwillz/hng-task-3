...
function Hero() {
  ...
  return (
    <main className="flex flex-col gap-4 md:mt-[80px] px-4 items-center justify-center md:flex-row md:justify-between md:items-center max-w-6xl mx-auto ">
      <div className=" w-full md:w-40%">
        ...
        <form className="flex items-center mt-[30px]">
          ...
          />
          <button className="rounded-r-[8px] h-[54px] w-[230px] leading-[19.2px] text-white bg-[#a02279]">
            Search
          </button>
        </form>
      </div>
